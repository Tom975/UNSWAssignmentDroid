...
public class TripTable {
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " + TripTableEntry.TABLE_NAME +
            " (" + TripTableEntry._ID + "INTEGER PRIMARY KEY," + TripTableEntry.COLUMN_NAME_REGISTRATION + " TEXT," +
            TripTableEntry.COLUMN_NAME_MAKE + " TEXT," + TripTableEntry.COLUMN_NAME_MODEL + " TEXT," +
            TripTableEntry.COLUMN_NAME_YEAR + " DATE," + TripTableEntry.COLUMN_NAME_ENGINE + "TEXT)";
